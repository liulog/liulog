...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&center=true&width=480&lines=Systems+Programming+Enthusiast;RISC-V+%7C+Virtualization+%7C+Hypervisor;AI+Inference+%7C+Bare-metal;RoboMaster+Alumni+%7C+Open+Source" />
</p>
...
- 🤖 **RMer** (HUST LY): 2023 | Hero | Algorithm
- ♋ **Traits**: Cancer — meticulous
- 🎯 **Focus**: `RISC-V` · `Virtualization` · `Inference` · `Robot` · `System Security`
...
| Done | Next |
|:---:|:---:|
| RISC-V Arch · Virtualization · Bare-metal · CUDA · Inference | System Security |
